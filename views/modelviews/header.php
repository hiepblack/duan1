            ...
            <div class="container mx-auto bg-transparent ">
                <div class="grid grid-cols-3 gap-4 pt-4">
                    <div class=" h-[45px]  w-[360px]" id="menu1">
                        <form action="../customer/search.php" class="w-full flex" method="post">
                            <input type="text" placeholder="Tìm kiếm sản phẩm..." name ="search" class="w-5/6 border-b border-inherit outline-none pl-2 bg-transparent placeholder:text-inherit">
