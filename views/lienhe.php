<div class="grid grid-cols-2 my-4">
    ...
    <div class="p-8">
        ...
        <form>
            ...
            <div class="mb-4 mt-4">
                <input type="email" placeholder="Email của bạn" class="border pl-2 pt-2 pb-2 mr-2 bg-[#F5F5F5]">
                <input type="text" placeholder="Số điện thoại của bạn" class="border pl-2 pt-2 pb-2 ml-2 bg-[#F5F5F5]">
            </div>
            <textarea name="" id="" cols="30" rows="10" placeholder="Nội dung" class="border w-full mt-4 pl-2 bg-[#F5F5F5]"></textarea>
            <button class="border pr-7 pl-7 pt-4 pb-4 bg-black text-white hover:bg-white hover:text-black mt-10 mb-10">GỬI CHO CHÚNG TÔI</button>
        </form>
    </div>
</div>