<div class="container mx-auto">
    ...
    <main class="my-10 flex px-10 w-full">
        <aside class=" w-3/12 px-4">
            <div class="border px-4 py-6 mb-10 md:block hidden">
            ...
            <div class="border px-4 py-6 md:block hidden">
        ...
        <section class="md:w-9/12 w-full px-4">
            ...
            <?php foreach ($blog as $value) : ?>
                <a href="http://localhost/WEB17301/Du_an_1/views/index.php?act=chitiet_blog&id=<?php echo $value['blogId']?>&userid=<?php echo $value['userId']?>">
                    <div class="md:flex block py-4 w-10/12 ">
                        <div class="overflow-hidden">
                            <img class="md:w-[235px] md:h-[180px] w-full h-full transition hover:duration-650 hover:ease-in-out hover:scale-[1.2]" src="../img/<?php echo $value['imageBlog'] ?>" alt="">
                        </div>
                        <div class="pl-5 ">
